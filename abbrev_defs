...
(define-abbrev-table 'scheme-mode-abbrev-table
  '(
    ("cond" "" tempo-template-scheme-cond 0)
...
(define-abbrev-table 'scheme48-mode-abbrev-table
  '(
    ("cond" "" tempo-template-scheme-cond 2)
    ("define" "" tempo-template-scheme-define 0)
...
(define-abbrev-table 'text-mode-abbrev-table
  '(
    ("bkt" "barkeit" nil 0)
    ("bzgl" "bezüglich" nil 0)
    ("fÜr" "für" nil 0)
    ("ggf" "gegebenenfalls" nil 0)
    ("gr" "Gruß
