...
(define-abbrev-table 'message-mode-abbrev-table '(    ("gr" "Gruß
...
(define-abbrev-table 'scheme-mode-abbrev-table '(    ("cond" "" tempo-template-scheme-cond 0)
    ("define" "" tempo-template-scheme-define 0)
    ("defun" "" tempo-template-scheme-defun 0)
    ("if" "" tempo-template-scheme-if 0)
    ("lambda" "" tempo-template-scheme-lambda 0)
    ("let" "" tempo-template-scheme-let 0)
    ("let*" "" tempo-template-scheme-let* 0)
    ("lets" "" tempo-template-scheme-lets 0)
    ("loop" "" tempo-template-scheme-loop 0)
    ("scheme-defun" "" tempo-template-scheme-scheme-defun 0)
    ("unless" "" tempo-template-scheme-unless 0)
    ("when" "" tempo-template-scheme-when 0)
    ))

(define-abbrev-table 'scheme48-mode-abbrev-table '(    ("cond" "" tempo-template-scheme-cond 2)
    ("define" "" tempo-template-scheme-define 0)
    ("defun" "" tempo-template-scheme-defun 2)
    ("if" "" tempo-template-scheme-if 0)
    ("lambda" "" tempo-template-scheme-lambda 0)
    ("let" "" tempo-template-scheme-let 3)
    ("lets" "" tempo-template-scheme-lets 0)
    ("loop" "" tempo-template-scheme-loop 1)
    ("unless" "" tempo-template-scheme-unless 0)
    ("when" "" tempo-template-scheme-when 0)
    ))
...
(define-abbrev-table 'shell-mode-abbrev-table '(    (",g" "| grep" nil 0)
    (",gg" "2>&1 | grep" nil 0)
    (",nn" "> /dev/null 2>&1" nil 0)
    (",nul" "/dev/null" nil 0)
    (",s" "| sort " nil 0)
...
(define-abbrev-table 'text-mode-abbrev-table '(    ("ggf" "gegebenenfalls" nil 3)
    ("gr" "Gruß
