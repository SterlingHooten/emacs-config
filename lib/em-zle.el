...
;; Time-stamp: <2003-07-10 14:53:27 Emilio C. Lopes>
...
;; =======
;;
;; ZLE Function                 ZSH Binding     EShell Binding 
;; --------------------------------------------------------------
;; insert-last-word             M-.             C-c M-.
;; copy-prev-shell-word         C-M-_           C-c M-_
;; push-line                    M-q             C-c M-RET
;; get-line                     M-g             C-c M-g
;; accept-and-hold              M-a             C-c M-a
;; kill-whole-line              C-u             nil
;; which-command                M-?             C-c M-?
;;
;; Installation
;; ============
;;
...
;; keys. See the GNU Emacs on-line documentation for details.

;;; Code:
...
;; vielleicht kann `eshell-save-history-index' hier helfen...
...
;; `eshell-get-next-from-history' als basis für `accept-and-infer-next-history'
